...
public class TelaEx4 extends JFrame {
	...
	public TelaEx4() {
		...
		Ex4Action Ex4Action = new Ex4Action(btnCorrer, lblCarro1, lblCarro2, Vencedor, Perdedor);
		btnCorrer.setBounds(31, 276, 97, 25);
		contentPane.add(btnCorrer);
		btnCorrer.addActionListener(Ex4Action);
		
		JLabel label = new JLabel("________________________________________________________________________________________________________\r\n");
