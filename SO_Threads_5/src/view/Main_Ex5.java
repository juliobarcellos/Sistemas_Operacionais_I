...
public class Main_Ex5 extends JFrame {
	...
	public Main_Ex5() {
		...
		Ex5_Action Ex4Action = new Ex5_Action(btnCorrer, lblCarro1, lblCarro2, Vencedor, Perdedor);
